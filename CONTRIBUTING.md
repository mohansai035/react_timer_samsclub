# Contributing to react-timer-machine

Love react-timer-machine and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yassinedoghri/react-timer-machine/issues) is
...
git clone https://github.com/<your-username>/react-timer-machine.git
# Navigate to the newly cloned directory
cd react-timer-machine
# Assign the original repo to a remote called "upstream"
git remote add upstream https://github.com/yassinedoghri/react-timer-machine.git
```
...
owners to license your work under the terms of the [MIT License](https://github.com/yassinedoghri/react-timer-machine/blob/master/LICENSE).
